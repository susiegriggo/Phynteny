...
def create_plot(
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("function")[0] == "unknown function"
            and f.qualifiers.get("phynteny")[0] == "unknown function"
        ):
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("phynteny")[0] == "other"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            fwd_list.append(f)
    ...
    for f in gff.extract_features("CDS", target_strand=-1):
        if (
            f.qualifiers.get("function")[0] == "other"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            rev_list.append(f)
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("phynteny")[0] == "tail"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            fwd_list.append(f)
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("phynteny")[0] == "transcription regulation"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            fwd_list.append(f)
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("phynteny")[0] == "DNA"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            fwd_list.append(f)
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("phynteny")[0] == "lysis"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            fwd_list.append(f)
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("phynteny")[0] == "moron"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            fwd_list.append(f)
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("phynteny")[0] == "integration and excision"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            fwd_list.append(f)
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("phynteny")[0] == "head and packaging"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            fwd_list.append(f)
    ...
    for f in gff.extract_features("CDS", target_strand=1):
        if (
            f.qualifiers.get("phynteny")[0] == "connector"
            and f.qualifiers.get("function")[0] == "unknown function"
        ):
            fwd_list.append(f)
