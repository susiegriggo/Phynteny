...
def main():
    ...
    X_list, y_list, idx_list = statistics.prepare_test_data(test_encodings, test_features, num_functions, n_features,
                                                            max_length)
    ...
    all_prob_list, all_cat_list, cat_list, prob_list = statistics.get_predictions(X_list, y_list, idx_list, model,
                                                                                  num_functions, n_features, max_length)
